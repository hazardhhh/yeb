  ...
  <div>
    <div>
      <div style="display: flex;justify-content: space-between">
        <div>
          <el-input style="width: 300px;margin-right: 10px" prefix-icon="el-icon-search" clearable @clear="initEmps"
                    :disabled="showAdvanceSearchVisible"
                    v-model="empName" @keydown.enter.native="initEmps" placeholder="请输入员工名进行搜索..."></el-input>
          <el-button type="primary" icon="el-icon-search" @click="initEmps" :disabled="showAdvanceSearchVisible">搜索
          </el-button>
          <el-button type="primary" @click="doAdvanceSearch"><i
        ...
        <div>
          ...
          <el-button @click="exportData" type="success" icon="el-icon-download" :disabled="importDataDisabled">导出数据
          </el-button>
    ...
    <transition name="slide-fade">
      <div v-show="showAdvanceSearchVisible" style="border: 1px solid #409eff;border-radius: 5px;
           box-sizing: border-box;padding: 10px;margin: 10px 0px">
        <el-row>
          <el-col :span="5">
            政治面貌：
              ...
              <div style="margin-left: 5px">
                <el-popover
                  ...
                  <div slot="reference" style="width: 130px;display: inline-flex;border: 1px solid #dedede;
                   margin-top: 3px;height: 25px;border-radius: 5px;cursor: pointer;align-items: center;
                   font-size: 12px;padding-left: 14px;box-sizing: border-box" @click="showDepView2">
                    {{ inputDepName }}
                  </div>
                </el-popover>
              </div>
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="工号:" prop="workID">
                <el-input v-model="emp.workID" placeholder="请输入工号" prefix-icon="el-icon-edit"
                          disabled size="mini" style="width: 150px"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="5">
            ...
            <el-col :span="6">
              <el-form-item label="毕业院校:" prop="school">
                <el-input v-model="emp.school" placeholder="请输入院校" prefix-icon="el-icon-edit"
                          size="mini" style="width: 150px"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="7">
