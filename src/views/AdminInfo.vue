      ...
      <div>
        <div style="display: flex;justify-content: center; margin-bottom: 10px">
          <el-upload
            ...
            <img title="点击修改用户头像" :src="admin.userFace" alt="" style="height: 100px; width: 100px; border-radius: 50px">
          </el-upload>
        </div>
        <div>电话号码：
          <el-tag>{{ admin.telephone }}</el-tag>
        </div>
        <div style="margin-top: 5px">手机号码：
          <el-tag>{{ admin.phone }}</el-tag>
        </div>
        <div style="margin-top: 5px">居住地址：
          <el-tag>{{ admin.address }}</el-tag>
        </div>
        <div v-for="(item, index) in admin.roles" :key="index" style="margin-top: 5px">用户标签：
