<template>
  <div>
    <div>
      <el-input size="small" v-model="jl.name" placeholder="添加职称等级..."
    ...
    <el-dialog
      ...
      <table>
        <tr>
          ...
          <td>
            <el-input v-model="updateJl.name" size="small" style="width:230px;margin-left: 6px"></el-input>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <el-select size="small" v-model="updateJl.titleLevel" placeholder="职称等级"
                       style="width:230px;margin-left: 6px;margin-right: 6px">
              <el-option
                  v-for="item in titleLevels"
                  :key="item"
                  :label="item"
